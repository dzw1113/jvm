...
public class HashMap<K,V> extends AbstractMap<K,V>
    ...
    /**
     * Node是单向链表，它实现了Map.Entry接口(请参阅下面
     * TreeNode 子类,子类 LinkedHashMap 的条目)
     */
    static class Node<K,V> implements Map.Entry<K,V> {
        ...
        Node(int hash, K key, V value, Node<K,V> next) {//构造函数Hash值 键 值 下一个节点
            this.hash = hash;
            this.key = key;
            this.value = value;
            this.next = next;
        ...
        public final boolean equals(Object o) {//判断两个node是否相等,若key和value都相等，返回true。可以与自身比较为true
            if (o == this)
                return true;
    ...
    /**
     * 将m中的所有元素添加至HashMap中，实现了Map.putAll and Map的构造函数
     * 
     * @param m the map
    ...
    /**
     * 如果实现了Comparable，返回x的CLass。否则返回null
     */
