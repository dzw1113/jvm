...
public class ASMGettingStarted{
	...
	{
		//注意，这里需要把classname里面的.改成/，如reflect.proxy.asm.Tester改成reflect/proxy/asm/Tester
	...
	{
		String className = "reflect.proxy.asm.Tester";
		byte[] classData = createVoidMethod(className, "我是被ASM生成的！");
