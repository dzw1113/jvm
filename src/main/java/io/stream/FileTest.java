 ...
 * 
 * File
 * 直接继承于Object，实现了Serializable接口和Comparable接口。实现Serializable接口，意味着File对象支持序列化操作。
 * 
...
public class FileTest {
	...
	public static void testFileDirAPIS() {
		try {
			...
			System.out.printf("%30s = %s is \"%s\"\n", "s1_normal.lastModified()", s1_normal.lastModified(),
					getModifyTime(s1_normal.lastModified()));
