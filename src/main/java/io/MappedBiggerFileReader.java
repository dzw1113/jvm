...
/**
 * 内存映射分批次（一批次为2G=Integer.MAX_VALUE）读取
 * @author dzw
 *
 */
public class MappedBiggerFileReader {
	public static void main(String[] args) throws IOException {
		MappedBiggerFileReader reader = new MappedBiggerFileReader("e:\\CentOS-7-x86_64-DVD-1804.iso", 65536);
		...
		reader.close();
		System.out.println("MappedBiggerFileReader: " + ((end - start) / 1000000L) + "毫秒");
	}
